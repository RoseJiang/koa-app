...
import { addProfile, getCurrentProfile } from '../../actions/profileAction'
...
class EditProfile extends Component {
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.profile.profile) {
            ...
            profile.wangyiyunkt = isEmpty(profile.social.wangyiyunkt) ? '' : profile.social.wangyiyunkt;
            //console.log(profile);
            this.setState({
                ...
                skills: profile.skills.join(','),//required
                githubusername: profile.githubusername,
                bio: profile.bio,
                wechat: profile.wechat,
                QQ: profile.QQ,
                tengxunkt: profile.tengxunkt,
                wangyiyunkt: profile.wangyiyunkt,
